...
if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
{
    ...
    if(isset($_POST['update'])){
        ...
        // Check if the updated class arm already exists
        $checkQuery = mysqli_query($conn, "select * from tblclassarms where classArmName ='$classArmName' and classId = '$classId' and Id != '$Id'");
       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Create Class Groups</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Create Class Groups</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Create Class Groups</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-xl-6">
                        <label class="form-control-label">Class Group Name<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" name="classArmName" value="<?php echo isset($row['classArmName']) ? $row['classArmName'] : ''; ?>" id="exampleInputFirstName" placeholder="Class Arm Name">
                        </div>
                      </div>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                      <h6 class="m-0 font-weight-bold text-primary">All Class Groups</h6>
                    </div>
                            ...
                            while ($rows = $rs->fetch_assoc())
                              {
                                ...
                                echo"
                                  <tr>
                                    ...
                                    <td><a href='javascript:void(0);' class='delete-confirm' data-id='".$rows['Id']."'><i class='fas fa-fw fa-trash'></i>Delete</a></td>
                                  </tr>";
                              }
                          }
                          else
