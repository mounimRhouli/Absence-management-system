 <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center bg-gradient-primary justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">EPG_AMS</div>
      </a>
      ...
      Attendance
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrap2"
          ...
          <span>View My Absences</span>
        </a>
        <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">View My Absences</h6>
            <a class="collapse-item" href="student_attendance.php">Absences</a>
      ...
      Timetable
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrapcon" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">View My Timetable</h6>
            <a class="collapse-item" href="student_timetable.php">Timetable</a>
